...
# Does not quite work as a standalone unattended update script but you get the idea
...
touch /var/lib/mopidy/playlists/d.m3u
chmod -R g+rwX /var/lib/mopidy/
chmod -R g+s /var/lib/mopidy/
mpc save Disco
